...
// ------------------------------------------------------------------------------ //
//                              OpenCollar - titler                               //
//                                 version 3.960 - Fixed by EricSorensen          //
// ------------------------------------------------------------------------------ //
...
string g_sPrimName = "R_F";   //description text of the hovertext prim.  Needs to be separated from the menu name.
...
default{
    state_entry(){
        ...
        while (linkNumber-- >2){
            string primName = llList2String(llGetLinkPrimitiveParams(linkNumber, [PRIM_NAME]),0);
           
            if (llSubStringIndex(primName, g_sPrimName) == 0) {
